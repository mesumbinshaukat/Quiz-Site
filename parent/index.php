...
$email = $_COOKIE["email"];
$fetch_parent = "SELECT * FROM `db_parents` WHERE `email` = '$email'";
$fetch_parent_result = mysqli_query($conn, $fetch_parent);

$parent = mysqli_fetch_assoc($fetch_parent_result);

$std_query = "SELECT * FROM `db_students` WHERE `parent_id` = {$parent['id']}";
                        ...
                        <div class="card card-form">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                    while ($fetch_std = mysqli_fetch_assoc($std_result)) {
                                        $result_query = "SELECT * FROM `db_result` WHERE `student_id` = {$fetch_std['id']}";
